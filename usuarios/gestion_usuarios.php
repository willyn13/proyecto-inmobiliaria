	...
	$display.="<table>";
		if (mysqli_num_rows($resultado)==0 ){
			$display.="<p class=\"error\"><i>No hay comerciales.</i></p>";
                        ...
                        $display.="<a href=\"alta_comercial.php\"><input type='SUBMIT' name='SUBMIT' value='Dar de Alta un Usuario'></a>";
			$display.="<tr>
				<th></th>
				<th></th>
                                <th>DNI</th>
		...
		while($reg=mysqli_fetch_array($resultado) ){
			...
			$display.="<tr>
				<td><a href=\"eliminar_comercial.php?dni_usuario=".$dni_usuario."\"><input type='button' id='id_eliminar_usuario' value='Eliminar'></a></td>
				<td><a href=\"modificar_comercial.php?dni_usuario=".$dni_usuario."\"><input type='button' id='id_modificar_usuario' value='Modificar'></a></td>
				<td>".$dni_usuario."</td>	
				<td>".$nombre."</td>
				<td>".$apellidos."</td>
				<td>".$cargo."</td>
