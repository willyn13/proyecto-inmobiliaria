...
?>
			...
			<tr>
				...
				<td><input type="text" id="habitaciones" placeholder="Escribe habitaciones" name="habitaciones" value="<?php echo $inmueble[5] ?>" /></td>
			</tr>		
			<tr>
				<td><label for="m2"> Metros cuadrados: </label></td>
				<td><input type="text" id="m2" placeholder="Escribe m2" name="m2" value="<?php echo $inmueble[6] ?>" /></td>
			</tr>	
			<tr>
				<td><label for="banios"> Baños: </label></td>
				<td><input type="text" id="bagnos" placeholder="Escribe bagnos" name="banios" value="<?php echo $inmueble[7] ?>" /></td>
			</tr>	
			<tr>
...
?>
			...
			<tr>
				...
				<td><input type="text" id="direccion" placeholder="Escribe direccion" name="direccion" value="<?php echo $inmueble[12] ?>" /></td>
			</tr>	
			<tr>
...
if($idlocalidad[0]<>$inmueble[1]) echo "<option value='".$idlocalidad[0]."'>".$idlocalidad[1]."</option>";
}
...
?>  </td>
			...
			<tr>
				...
				<td><input type="text" id="precio_venta" placeholder="Escribe precio_venta" name="precio_venta" value="<?php echo $inmueble[13] ?>" /></td>
			</tr>	
			<tr>
				<td><label for="precio_alquiler"> Precio_alquiler: </label></td>
				<td><input type="text" id="precio_alquiler" placeholder="Escribe precio_alquiler" name="precio_alquiler" value="<?php echo $inmueble[14] ?>" /></td>
			</tr>
