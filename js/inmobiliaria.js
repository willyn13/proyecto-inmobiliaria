    ...
    var v_pantallaContacto = 
        '<div class="cls_footer">\n\
            ...
            <p>Fax: 91 759 38 65</p>\n\
                ...
                <p>Si tu llamada tiene que ver con un anuncio que has puesto llámanos desde el teléfono de contacto que indicaste en él formulario.</p>\n\
                <p>De esta forma podremos acceder a los datos de tu anuncio y ayudarte lo más rápido posible.</p>\n\
                <p>Sentimos mucho que la atención telefónica no pueda ser gratuita, pero el servicio personal tiene un coste que no podemos asumir.</p>\n\
                <p>También puedes enviarnos un mensaje por aquí <a href="mailto:tuhogar@inmobiliaria.com?subject=Asunto&body=Mensaje">tuhogar@inmobiliaria.com</a></p>\n\
        </div>';
...
$(document).on('click',"#id_somos",function(event){
    ...
    var v_pantallaSomos = 
        '<div class="cls_footer">\n\
            ...
            Satisfacer las demandas de nuestros Clientes.<p>\n\
            ...
            <p>Una agencia joven con profesionales expertos y dinámicos.<p>\n\
...
$(document).on('click',"#id_condiciones",function(event){
    ...
    var v_pantallaCondiciones = 
        '<div class="cls_footer">\n\
            ...
            el software, los productos o los servicios que pueda obtener de este sitio Web.</p>\n\
            ...
            de los mismos por parte nuestra ni la existencia de ningún tipo de asociación ni las personas que los operan.</p>\n\
            ...
            suspender su difusión total o parcialmente y de modificar la estructura y contenido de este sitio sin previo aviso.</p>\n\
            <h3>INFORMACIÓN</h3>\n\
            ...
            el acceso de cualquier usuario a este sitio Web o a alguna parte del mismo.</p>\n\
